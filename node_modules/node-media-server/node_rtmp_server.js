...
var cert = {
  ...
  key: fs.readFileSync('/home/debian/rtmp-node/private-key.pem'),
  cert: fs.readFileSync('/home/debian/rtmp-node/public-cert.pem')
...
class NodeRtmpServer {
  constructor(config) {
    ...
    this.tcpServer = Net.createServer(cerf, (socket) => {
      // console.log(socket)
  ...
  run() {
    this.tcpServer.listen(this.port, cerf, () => {
